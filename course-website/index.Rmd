...
We'll learn stuff. Industry standard stuff.[^1]

[^1]: For example, this very website was built with `R`. Powerful stuff.
...
1.  Click the book icon in the top-right corner of the course website. This will take you to our [Hypothesis Group Page](https://hypothes.is/groups/eE6yBNm8/test-group).
...
5.  Go to the [syllabus](https://joeornstein.github.io/pols-3230/) and add your questions/comments/memes. Whenever you annotate a reading, just make sure that you are posting to the Group instead of Public (see the dropdown menu at the top of the extension).
